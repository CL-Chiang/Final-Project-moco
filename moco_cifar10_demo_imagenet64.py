...
Original file is located at
    https://colab.research.google.com/drive/1xYaw5J2uNl_FDGDdTVmp-NQZ2bQdEqHP
...
args.data = "/home/tyler/PycharmProjects/"
args.results_dir = "/home/tyler/PycharmProjects/results"
'''
...
#################################################### ImageNet code added by Tyler
print('right before defining traindir')
traindir = os.path.join(args.data, 'train')
train_dataset = datasets.ImageFolder(traindir, moco.loader.TwoCropsTransform(transforms.Compose(train_transform)))
train_sampler = None
...
class ModelMoCo(nn.Module):
    def __init__(self, dim=128, K=4096, m=0.99, T=0.1, arch='resnet18', bn_splits=8, symmetric=True):
        ...
        self.K = K
        #self.m = m
        self.m = 0.999 #Tyler's change to understand the effect of the momentum hyperparameter
        self.T = T
